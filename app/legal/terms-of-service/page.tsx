	...
	return (
		<div className="min-h-screen">
			...
			<main className="flex flex-col items-center py-2 md:p-6 xl:px-20 2xl:px-24">
				...
				<object
					data="https://general-s3-public.s3.us-east-2.amazonaws.com/novolem-terms-of-service-main.pdf"
				...
				>
					<p className="px-8 2xl:px-24">
						...
						<a href="https://general-s3-public.s3.us-east-2.amazonaws.com/novolem-terms-of-service-main.pdf">here</a>.
					</p>
				</object>
			</main>
			<Footer />
